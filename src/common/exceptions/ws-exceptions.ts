...
export class WsBadRequestExeption extends WsTypeException {
  constructor(message: string | unknown) {
    super('BadRequest', message);
  }
}

export class WsUnauthorizedExeption extends WsTypeException {
  constructor(message: string | unknown) {
    super('Unauthorized', message);
  }
}
export class WsUnknownExeption extends WsTypeException {
  constructor(message: string | unknown) {
